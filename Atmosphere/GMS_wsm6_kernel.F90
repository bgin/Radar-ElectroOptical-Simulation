...
!
  ...
  !dir$ attributes align : 64 :: picond
  ...
  !dir$ attributes align : 64 :: mstep
  !dir$ attributes align : 64 :: numdt
...
!     emanuel(1994)
      !
         !dir$ assume_aligned cpm:64
         !dir$ assume_aligned q:64
         !dir$ assume_aligned xl:64
...
!    initialize the surface rain, snow, graupel
      !
      !dir$ vector always, aligned, nontemporal(rainncv,snowncv,graupelncv,sr,tstepsnow,tstepgraup)
      !dir$ unroll(16)
      do i = its, ite
        rainncv(i) = 0.
...
!
      ...
      do k = kts, kte
         ...
         !dir$ vector nontemporal(prevp,psdep,pgdep,praut,psaut)
         !dir$ vector nontemporal(pgaut,pracw,praci,piacr,psaci)
         !dir$ vector nontemporal(psacw,pracs,psacr,pgacw,paacw)
         !dir$ vector nontemporal(pgaci,pgacr,pgacs,pigen,pidep)
         !dir$ vector nontemporal(pcond,psmlt,pgmlt,pseml,pgeml)
         !dir$ vector nontemporal(psevp,pgevp,falk,fall,fallc,falkc)
         !dir$ unroll(16)
         !dir$ code_align(32)
         do i = its, ite
...
!     first, vertical terminal velosity for minor loops
      ...
      !dir$ assume_aligned qrs:64,denqrs1:64
      !dir$ assume_aligned fall:64,denqrs1:64
      !dir$ assume_aligned denqrs2:64,denqrs3:64
       !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kts, kte
        ...
        enddo
     enddo
      !dir$ assume_aligned fall:64,delqrs1:64,delz:64
      !dir$ assume_aligned delqrs2:64,delqrs3:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      !dir$ unroll(4)
      ...
      enddo
      !dir$ assume_aligned qrs_tmp;64,qrs:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kts, kte
      ...
      call slope_wsm6(qrs_tmp,den_tmp,denfac,t,rslope,rslopeb,rslope2,rslope3, &
                     work1,its,ite,kts,kte)
!
      !dir$ assume_aligned t:64,n0sfac:64,work2:64
      !dir$ assume_aligned p:64,t:64,den:64,qrs:64
      !dir$ assume_aligned rslope2:64,rslope:64
      !dir$ assume_aligned rslopeb:64,psmlt:64
      !dir$ assume_aligned pgmlt:64,cpm:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kte, kts, -1 
...
!---------------------------------------------------------------
      !dir$ assume_aligned qci:64,work1c:64,den:64
      !dir$ assume_aligned xni:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
...
!
      !dir$ assume_aligned denqci:64,den:64,qci:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kte, kts, -1
      ...
      call _NISLFV_RAIN_PLM_(its,ite,kts,kte,den_tmp,denfac,t,delz_tmp,work1c,denqci,  &
                           delqi,dtcld,1,0)
      !dir$ assume_aligned qci:64,denqci:64,den:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kts, kte
        ...
        enddo
      enddo
      !dir$ assume_aligned fallc:64,delqi:64,delz:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ vector aligned
         !dir$ vector always vectorlength(16)
...
!
         ...
         !dir$ assume_aligned fall:64,fallc:64,delz:64
...
!       (T>T0: I->C)
!---------------------------------------------------------------
      !dir$ assume_aligned t:64,xl:64,qci:64,cpm:64
      !dir$ assume_aligned den:64,qrs:64,rslope3:64
      !dir$ assume_aligned rslope:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kts, kte
...
!
      !dir$ assume_aligned work1:64,xl:64,p:64,t:64,den:64
      !dir$ assume_aligned qs:64,work2:64
       !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kts, kte
...
!===============================================================
!
      !dir$ assume_aligned qs:64,qci:64,praut:64,qrs:64
      !dir$ assume_aligned pracw:64,rslope3:64.rslopeb:64
      !dir$ assume_aligned denfac:64,qrs:64,rslope2:64
      !dir$ assume_aligned prevp:64,rh:64,work1:64,work2:64
      !dir$ code_align(32)
      !dir$ block_loop factor(16) level(1)
      !dir$ block_loop factor(16) level(2)
      do k = kts, kte
