    ...
    MODULE wv_sat_methods
      ...
      ! elemental) interface.
        ...
        elemental FUNCTION goffgratch_svp_water(t) RESULT ( es )
          !$OMP DECLARE SIMD(goffgratch_svp_water)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: goffgratch_svp_water
          !DIR$ OPTIMIZE : 3
#endif
        ...
        elemental FUNCTION goffgratch_svp_ice(t) RESULT ( es )
          !$OMP DECLARE SIMD(goffgratch_svp_ice)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: goffgratch_svp_ice
           !DIR$ OPTIMIZE : 3
#endif          
            REAL(KIND=r8), intent(in) :: t ! Temperature in Kelvin
            REAL(KIND=r8) :: es ! SVP in Pa
        ...
        elemental FUNCTION murphykoop_svp_water(t) RESULT ( es )
          !$OMP DECLARE SIMD(murphykoop_svp_water)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: murphykoop_svp_water
          !DIR$ OPTIMIZE : 3
#endif            
            REAL(KIND=r8), intent(in) :: t ! Temperature in Kelvin
            REAL(KIND=r8) :: es ! SVP in Pa
        ...
        elemental FUNCTION murphykoop_svp_ice(t) RESULT ( es )
          !$OMP DECLARE SIMD(murphykoop_svp_ice)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: murphykoop_svp_ice
          !DIR$ OPTIMIZE : 3
#endif            
            REAL(KIND=r8), intent(in) :: t ! Temperature in Kelvin
            REAL(KIND=r8) :: es ! SVP in Pa
        ...
        elemental FUNCTION oldgoffgratch_svp_water(t) RESULT ( es )
          !$OMP DECLARE SIMD(oldgoffgratch_svp_water)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: oldgoffgratch_svp_water
          !DIR$ OPTIMIZE : 3
#endif            
            REAL(KIND=r8), intent(in) :: t
            REAL(KIND=r8) :: es
        ...
        elemental FUNCTION oldgoffgratch_svp_ice(t) RESULT ( es )
          !$OMP DECLARE SIMD(oldgoffgratch_svp_ice)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: oldgoffgratch_svp_ice
          !DIR$ OPTIMIZE : 3
#endif            
            REAL(KIND=r8), intent(in) :: t
            REAL(KIND=r8) :: es
        ...
        elemental FUNCTION bolton_svp_water(t) RESULT ( es )
          !$OMP DECLARE SIMD(bolton_svp_water)
#if defined(__INTEL_COMPILER) || defined(__ICC)
          !DIR$ CODE_ALIGN : 32 :: bolton_svp_water
          !DIR$ OPTIMIZE : 3
#endif 
