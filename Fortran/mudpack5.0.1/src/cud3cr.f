...
c
	...
	do j=1,ny
      ...
      subroutinecsubxy(nx,ny,nz,p,r,cxyxa,cxyxb,cxyyc,cxyyd,cxyze,cxyzf)
c
...
c
	...
	do i=2,nx-1
      ...
      subroutinecsubxz(nx,ny,nz,p,r,cxzxa,cxzxb,cxzyc,cxzyd,cxzze,cxzzf)
c
c     adjust right hand side r by subtracting off second order finite
...
c
	...
	do i=2,nx-1
      ...
      subroutinecsubyz(nx,ny,nz,p,r,cyzxa,cyzxb,cyzyc,cyzyd,cyzze,cyzzf)
c
c     adjust right hand side r by subtracting off second order finite
