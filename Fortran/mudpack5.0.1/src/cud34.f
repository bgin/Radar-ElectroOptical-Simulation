...
c ... purpose
c
c     cud34 attempts to improve the complex second order approximation generated
c     by cud3 to a fourth order approximation using difference corrections
...
c
c
      subroutine cud34(work,phi,ierror)
      implicit none
      complex phi(*),work(*)
      integer ierror
     ...
     +kcycle,iprer,ipost,intpol
      ...
      call cd34(nx,ny,nz,phi,work)
      end

      subroutine cd34(nx,ny,nz,phi,wk)
      implicit none
      integer nx,ny,nz
...
c
	...
	do j=1,ny
      ...
      subroutine ctr3(nx,ny,nz,u,cof)
c
