...
#ifndef __GMS_ANTENNA_EM_TYPES_v2_H__
#define __GMS_ANTENNA_EM_TYPES_v2_H__  29112231540


namespace file_info {

     const unsigned int GMS_ANTENNA_EM_TYPES_v2_MAJOR = 1;
     const unsigned int GMS_ANTENNA_EM_TYPES_v2_MINOR = 1;
     const unsigned int GMS_ANTENNA_EM_TYPES_v2_MICRO = 0;
     const unsigned int GMS_ANTENNA_EM_TYPES_v2_FULLVER =
       1000U*GMS_ANTENNA_EM_TYPES_v2_MAJOR+100U*GMS_ANTENNA_EM_TYPES_v2_MINOR+
       10U*GMS_ANTENNA_EM_TYPES_v2_MICRO;
     const char * const GMS_ANTENNA_EM_TYPES_v2_CREATION_DATE = "29-11-2022 15:40 +00200 (WED 29 NOV 2022 GMT+2)";
     const char * const GMS_ANTENNA_EM_TYPES_v2_BUILD_DATE    = __DATE__ " " __TIME__;
     const char * const GMS_ANTENNA_EM_TYPES_v2_SYNOPSIS      = "Antenna model dynamically allocated abstract data types."
...
// Enable non-temporal stores for this class only.
// defaulted to 0.
#if !defined (USE_GMS_ANTENNA_EM_TYPES_v2_NT_STORES)
#define USE_GMS_ANTENNA_EM_TYPES_v2_NT_STORES 0
#endif
          ...
          namespace  radiolocation {
              ...
              struct __ATTR_ALIGN__(64) E_c4_t {
                     ...
                     inline E_c4_t(const std::size_t _nx,
                             ...
                             switch (fsize) {
                                 case:0
                                      this->ex = (std::complex<float> * __restrict)
                                                 gms_mmap_4KiB(this->nx*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ey = (std::complex<float> * __restrict)
                                                 gms_mmap_4KiB(this->ny*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ez = (std::complex<float> * __restrict)
                                                 gms_mmap_4KiB(this->nz*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ismmap = true;
                                 break;
                                 case:1
                                      this->ex = (std::complex<float> * __restrict)
                                                 gms_mmap_2MiB(this->nx*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ey = (std::complex<float> * __restrict)
                                                 gms_mmap_2MiB(this->ny*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ez = (std::complex<float> * __restrict)
                                                 gms_mmap_2MiB(this->nz*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ismmap = true;
                                 break;
                                 case:2
                                      this->ex = (std::complex<float> * __restrict)
                                                 gms_mmap_1GiB(this->nx*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ey = (std::complex<float> * __restrict)
                                                 gms_mmap_1GiB(this->ny*sizeof(std::complex<float>),prot,flags,fd,offset);
                                      this->ez = (std::complex<float> * __restrict)
                                                 gms_mmap_1GiB(this->nz*sizeof(std::complex<float>),prot,flags,fd,offset); 
                                      this->ismmap = true;
                                 break;
                                 default :
                                      allocate();
                     ...
                     inline E_c4_t(const std::size_t _nx,
                          ...
                          allocate();
                          this->ismmap = false;
#if (USE_GMS_ANTENNA_EM_TYPES_v2_NT_STORES)  == 1
              ...
              struct __ATTR_ALIGN__(64) E_r4_t {
                   ...
                   inline void allocate() {
                        using namespace gms::common;
                        this->exr  = (float*)gms_mm_malloc(this->nx,64ULL);
                        this->exi  = (float*)gms_mm_malloc(this->nx,64ULL);
                        this->eyr  = (float*)gms_mm_malloc(this->ny,64ULL);
                        this->eyi  = (float*)gms_mm_malloc(this->ny,64ULL);
                        this->ezr  = (float*)gms_mm_malloc(this->nz,64ULL);
                        this->ezi  = (float*)gms_mm_malloc(this->nz,64ULL);
                   }    
              ...
              struct __ATTR_ALIGN__(64) H_r4_t {
                   ...
                   inline void allocate() {
                        using namespace gms::common;
                        this->mxr  = (float*)gms_mm_malloc(this->nx,64ULL);
                        this->mxi  = (float*)gms_mm_malloc(this->nx,64ULL);
                        this->myr  = (float*)gms_mm_malloc(this->ny,64ULL);
                        this->myi  = (float*)gms_mm_malloc(this->ny,64ULL);
                        this->mzr  = (float*)gms_mm_malloc(this->nz,64ULL);
                        this->mzi  = (float*)gms_mm_malloc(this->nz,64ULL);
                   }    
...
#endif /*__GMS_ANTENNA_EM_TYPES_v2_H__*/
