...
namespace gms {
           ...
           struct alignas(64) DC3D_c4_t final 
           {
                     ...
                     inline DC3D_c4_t(const std::vector<std::complex<float>> &Ex,    //shall be of the same size (no error checking implemented)
                          ...
                          const std::size_t leny = sizeof(std::complex<float>)*this->mny;
                          const std::size_t lenz = sizeof(std::complex<float>)*this->mnz;
                     ...
                     inline explicit DC3D_c4_t(const std::size_t nx,
	                  ...
	                  avx512_uncached_memmove(&this->m_Ex[0],&Ex[0],this->mnx);
	                  avx512_uncached_memmove(&this->m_Ey[0],&Ey[0],this->mny);
	                  avx512_uncached_memmove(&this->m_Ez[0],&Ez[0],this->mnz);
#else
	                  avx512_cached_memmove(&this->m_Ex[0],&Ex[0],this->mnx);
	                  avx512_cached_memmove(&this->m_Ey[0],&Ey[0],this->mny);
	                  avx512_cached_memmove(&this->m_Ez[0],&Ez[0],this->mnz);
#endif
                   }  
               ...
               struct alignas(64) DC3D_r4_t final 
               {
                                                ...
                                                const float * __restrict Ezi) noexcept(false)
                     {
	                      ...
	                      avx512_uncached_memmove(&this->m_Exi[0],&Exi[0],this->mnx);
	                      avx512_uncached_memmove(&this->m_Eyr[0],&Eyr[0],this->mny);
	                      avx512_uncached_memmove(&this->m_Eyi[0],&Eyi[0],this->mny);
	                      avx512_uncached_memmove(&this->m_Ezr[0],&Ezr[0],this->mnz);
	                      avx512_uncached_memmove(&this->m_Ezi[0],&Ezi[0],this->mnz);
#else
	                      avx512_cached_memmove(&this->m_Exr[0],&Exr[0],this->mnx);
	                      avx512_cached_memmove(&this->m_Exi[0],&Exi[0],this->mnx);
	                      avx512_cached_memmove(&this->m_Eyr[0],&Eyr[0],this->mny);
	                      avx512_cached_memmove(&this->m_Eyi[0],&Eyi[0],this->mny);
	                      avx512_cached_memmove(&this->m_Ezr[0],&Ezr[0],this->mnz);
	                      avx512_cached_memmove(&this->m_Ezi[0],&Ezi[0],this->mnz);
#endif          
                      }
            ...
            typename std::enable_if<std::is_floating_point<T>::value>::type> {
                   ...
                   inline    DC3D_t(  const std::size_t nx,
                          ...
                          const std::size_t lenz = sizeof(T)*this->m_nz;
#if (USE_GMS_DYN_CONTAINERS_NT_STORES)  == 1
	                  avx512_uncached_memmove(&this->m_Ex[0],&Ex[0],lenx);
	                  avx512_uncached_memmove(&this->m_Ey[0],&Ey[0],leny);
	                  avx512_uncached_memmove(&this->m_Ez[0],&Ez[0],lenz);
#else	         	                  	          
	                  avx512_cached_memmove(&this->m_Ex[0],&Ex[0],lenx);
	                  avx512_cached_memmove(&this->m_Ey[0],&Ey[0],leny);
	                  avx512_cached_memmove(&this->m_Ez[0],&Ez[0],lenz);
#endif
                   }  
