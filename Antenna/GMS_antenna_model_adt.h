...
#ifndef __GMS_ANTENNA_MODEL_ADT_H__
#define __GMS_ANTENNA_MODEL_ADT_H__ 201120221117


namespace file_info {

     const unsigned int GMS_ANTENNA_MODEL_ADT_MAJOR = 1;
     const unsigned int GMS_ANTENNA_MODEL_ADT_MINOR = 1;
     const unsigned int GMS_ANTENNA_MODEL_ADT_MICRO = 0;
     const unsigned int GMS_ANTENNA_MODEL_ADT_FULLVER =
       1000U*GMS_ANTENNA_MODEL_ADT_MAJOR+100U*GMS_ANTENNA_MODEL_ADT_MINOR+
       10U*GMS_ANTENNA_MODEL_ADT_MICRO;
     const char * const GMS_ANTENNA_MODEL_ADT_CREATION_DATE = "20-11-2022 11:17 +00200 (SUN 20 NOV 2022 GMT+2)";
     const char * const GMS_ANTENNA_MODEL_ADT_BUILD_DATE    = __DATE__ " " __TIME__;
     const char * const GMS_ANTENNA_MODEL_ADT_SYNOPSIS      = "Antenna model dynamically allocated abstract data types."
...
#endif /*__GMS_ANTENNA_MODEL_ADT_H__*/
