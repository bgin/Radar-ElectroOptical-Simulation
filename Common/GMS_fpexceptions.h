...
namespace file_info {
  ...
  const unsigned int gGMS_FPEXCEPTIONS_MINOR = 0U;
  ...
  const char * const pgGMS_FPEXCEPTIONS_BUILD_DATE  = "00-00-0000 00:00";
  const char * const pgGMS_FPEXCEPTIONS_AUTHOR      = "Programmer: Bernard Gingold e-mail: beniekg@gmail.com";
