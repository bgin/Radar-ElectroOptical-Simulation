...
#ifndef __GMS_FILON_COS_QUAD_HPP__
#define __GMS_FILON_COS_QUAD_HPP__ 071020220903


namespace file_info {


        const unsigned int GMS_FILON_COS_QUAD_MAJOR = 1;

	const unsigned int GMS_FILON_COS_QUAD_MINOR = 1;

	const unsigned int GMS_FILON_COS_QUAD_MICRO = 0;

	const unsigned int GMS_FILON_COS_QUAD_FULLVER = 
		1000U*GMS_FILON_COS_QUAD_MAJOR+100U*GMS_FILON_COS_QUAD_MINOR+10U*GMS_FILON_COS_QUAD_MICRO;

	const char * const GMS_FILON_COS_QUAD_CREATE_DATE = "07-10-2022 09:03 +00200 (FRI 07 OCT 2022 GMT+2)";

	const char * const GMS_FILON_COS_QUAD_BUILD_DATE = __DATE__ " " __TIME__;

	const char * const GMS_FILON_COS_QUAD_AUTHOR = "Tabulated data integrator ported from Fortran version";
...
#include "GMS_malloc.h"
                        ...
                        __ATTR_ALIGN__(32)
			static inline
                        void filon_cos(const int32_t ntab,
...
#endif /*__GMS_FILON_COS_QUAD_HPP__*/
