...
c ... purpose
c
c     muh34 attempts to improve the second order approximation generated
c     by muh3 to a fourth order approximation using difference corrections
...
c
c
      subroutine muh34(wk,iwk,phi,ierror)
      implicit none
      integer iwk(*)
      real phi(*),wk(*)
     ...
     +kcycle,iprer,ipost,intpol
      ...
      call mh34(nx,ny,nz,phi,wk,iwk)
      end

      subroutine mh34(nx,ny,nz,phi,wk,iwk)
      implicit none
...
c
	...
	do j=1,ny
      ...
      subroutine trh3(nx,ny,nz,u,cof)
c
...
c
     ...
     +               dlx4,dly4,dlz4
      ...
      real ux3,ux4,uy3,uy4,uz3,uz4,cxx,cx,cyy,cy,czz,cz,tx,ty,tz
      do k=1,nz
	do j=1,ny
	  do i=1,nx
	    cof(i,j,k,8) = 0.0
...
c
!$OMP PARALLEL DO PRIVATE(i,j,k,ux3,ux4,uy3,uy4,uz3,uz4,cxx,cx,cyy,cy)
