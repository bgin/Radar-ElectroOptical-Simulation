...
const gms::math::ZMM16c4
gms::math::ZMM16c4::CZERO = ZMM16c4{};
...
gms::math::ZMM16c4
::ZMM16c4(const ZMM16c8Payload x) {
...
gms::math::ZMM16c4
::ZMM16c4(const double * __restrict Re,
...
gms::math::ZMM16c4 &
gms::math::ZMM16c4::load_a(const double * __restrict Re,
			       const double * __restrict Im) {
	m_re = _mm512_load_pd(&Re[0]);
	m_im = _mm512_load_pd(&Im[0]);
	return (*this);
...
gms::math::ZMM16c4 &
gms::math::ZMM16c4::load_u(const double * __restrict Re,
			       const double * __restrict Im) {
...
void 
gms::math::ZMM16c4::store_a(double * __restrict Re,
...
void 
gms::math::ZMM16c4::store_u(double * __restrict Re,
			      double * __restrict Im) const {
...
void 
gms::math::ZMM16c4::stream(double * __restrict Re,
			       double * __restrict Im) const {
...
double 
gms::math::ZMM16c4::extract_f64(const int32_t idx) const {
...
gms::math::ZMM16c4::extract_2f64(const int32_t re_idx,
...
gms::math::ZMM16c4 & 
gms::math::ZMM16c4::insert_1f64(const int32_t idx,
				    const double val) {
...
gms::math::ZMM16c4 & 
gms::math::ZMM16c4::insert_2f64(const int32_t re_idx,
				    const int32_t im_idx,
				    const double re,
				    const double im) {
...
__m256d 
gms::math::ZMM16c4::re_low2() const {
...
__m256d 
gms::math::ZMM16c4::re_hi2() const {
	return (_mm512_extractf64x4_pd(m_re, 1));
}


__m256d 
gms::math::ZMM16c4::im_low2() const {
	return (_mm512_extractf64x4_pd(m_im, 0));
}


__m256d 
gms::math::ZMM16c4::im_hi2() const {
...
static inline gms::math::ZMM16c4
gms::math::conj(const ZMM16c4 x) {
     auto tmp = ~x
     const __m512d im_part = tmp.m_im;
     return (ZMM16c4{x.m_re,im_part});
}
...
static inline gms::math::ZMM16c4
gms::math::carg(const ZMM16c4 x) {
       const __m512d re_part =
             _mm512_atan2_pd(x.m_im,x.m_re);
       return (ZMM16c4{re_part,_mm512_setzero_pd()});
}
...
static inline gms::math::ZMM16c4
gms::math::csinh(const ZMM16c4 x) {
        const __m512d re_part =
...
static inline gms::math::ZMM16c4
gms::math::ccosh(const ZMM16c4 x) {
        const __m512d re_part =
	       _mm512_mul_pd(_mm512_cosh_pd(x.m_re),
	       _mm512_cos_pd(x.m_im));
	const __m512d im_part =
...
static inline gms::math::ZMM16c4
gms::math::cpowi(const ZMM16c4 x,
                 const double n) {
	const __m512d re_part =
		_mm512_mul_pd(x.m_re, x.m_re);
	const __m512d im_part =
	...
	return (ZMM16c4{ _mm512_mul_pd(pow_term, _mm512_cos_pd(trig_arg)),
		_mm512_mul_pd(pow_term, _mm512_sin_pd(trig_arg)) });
}


static inline gms::math::ZMM16c4
gms::math::clog(const ZMM16c4 x) {
        auto tmp1 = cabs(x);
	auto tmp2 = carg(x);
        const __m512d re_part =
             _mm512_log_pd(tmp1);

        return (ZMM16c4{re_part,tmp2.m_re});    
}


static inline gms::math::ZMM16c4
gms::math::csqrt(const ZMM16c4 x) {
       auto tmp = cabs(x);
       const __m512d re_part =
       ...
       return (ZMM16c4{_mm512_sqrt_pd(re_part),
                           _mm512_sqrt_pd(im_part)});
}


static inline gms::math::ZMM16c4
gms::math::ctan(const ZMM16c4 x) {
...
static inline gms::math::ZMM16c4
gms::math::ctanh(const ZMM16c4 x) {
...
static inline gms::math::ZMM16c4
gms::math::select(const ZMM16c4 x,
		  const ZMM16c4 y,
		  const __mmask8 mask) {

	return (ZMM16c4{ _mm512_mask_blend_pd(mask, x.m_re, y.m_re),
		_mm512_mask_blend_pd(mask, x.m_im, y.m_im) });
}


static inline gms::math::ZMM16c4
gms::math::cdiv_smith(const ZMM16c4 x,
                      const ZMM16c4 y) {
...
gms::math::operator+(const ZMM16c4 x,
		     const ZMM16c4 y) {
	return (ZMM16c4{ _mm512_add_pd(x.m_re, y.m_re),
...
gms::math::operator+(const ZMM16c4 x,
                     const __m512d v) {
        return (ZMM16c4{_mm512_add_pd(x.m_re,v),
	                    x.m_im});
}
...
gms::math::operator+(const __m512d v,
                     const ZMM16c4 x) {
        return (ZMM16c4{_mm512_add_pd(v,x.m_re),
	                   x.m_im});
}
...
gms::math::operator-(const ZMM16c4 x,
		     const ZMM16c4 y) {
	return (ZMM16c4{ _mm512_sub_pd(x.m_re, y.m_re),
...
gms::math::operator-(const ZMM16c4 x,
                     const __m512d v ) {
        return (ZMM16c4{_mm512_sub_pd(x.m_re,v),
	                   x.m_im});
}
...
gms::math::operator-(const __m512d v,
                     const ZMM16c4 x) {
        return (ZMM16c4{_mm512_sub_pd(v,x.m_re),
	                   x.m_im});
}
...
gms::math::operator*(const ZMM16c4 x,
	...
	return (ZMM16c4{ _mm512_sub_pd(ymm0,ymm1),
...
gms::math::operator*(const ZMM16c4 x,
                     const __m512d v) {
        return (ZMM16c4{_mm512_mul_pd(x.m_re,v),
...
gms::math::operator*(const __m512d v,
                     const ZMM16c4 x) {
        return (ZMM16c4{_mm512_mul_pd(v,x.m_re),
...
gms::math::operator*(const ZMM16c4 x,
	...
	return (ZMM16c4{_mm512_mul_pd(x.m_re,zmm0),
...
gms::math::operator*(const double s,
		     const ZMM16c4 x) {
	const __m512d zmm0(_mm512_set1_pd(s));
	return (ZMM16c4{ _mm512_mul_pd(zmm0,x.m_re),
...
gms::math::operator/(const ZMM16c4 x,
	...
	return (ZMM16c4{ _mm512_div_pd(re_part,den),
...
gms::math::operator/(const ZMM16c4 x,
                     const __m512d v) {
        return (ZMM16c4{_mm512_div_pd(x.m_re,v),
...
gms::math::operator/(const __m512d v,
                     const ZMM16c4 x) {
        return (ZMM16c4{_mm512_div_pd(v,x.m_re),
...
gms::math::operator/(const ZMM16c4 x,
			 const double s) {
	const __m512d zmm0(_mm512_set1_pd(s));
	return (ZMM16c4{_mm512_div_pd(x.m_re,zmm0),
...
gms::math::operator/(const double s,
		   const ZMM16c4 x) {
	const __m512d zmm0(_mm512_set1_pd(s));
	return (ZMM16c4{ _mm512_div_pd(zmm0,x.m_re),
