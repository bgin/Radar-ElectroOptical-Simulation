...
__ATTR_HOT__ __ATTR_ALIGN__(16) _
gms::math::AVX512c4f32
...
gms::math::conj(const AVX512c4f32 x) {
     ...
     return (AVX512c4f32{x.m_re,tmp.im});
}
...
gms::math::select(const AVX512c4f32 x,
                  const AVX512c4f32 y,
		  __mmask16 mask) {
     return (AVX512c4f32{_mm512_mask_blend_ps(mask,x.m_re,y.m_re),
