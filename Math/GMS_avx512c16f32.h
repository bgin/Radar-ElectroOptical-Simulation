...
namespace gms {
	...
	__ATTR_VECTORCALL__
        ...
        operator*(const AVX512c16f32 x,
                     const __m512 v) {
              return (AVX512c16f32{_mm512_mul_ps(x.m_re,v),
       ...
       operator*(const __m512 v,
                 const AVX512c16f32 x) {
            return (AVX512c16f32{_mm512_mul_ps(v,x.m_re),
       ...
       operator*(const AVX512c16f32 x,
         ...
         const __m512 zmm0 = _mm512_set1_ps(s);
              return (AVX512c16f32{_mm512_mul_ps(x.m_re,zmm0),
	...
	__ATTR_VECTORCALL__
        ...
        operator/(const AVX512c16f32 x,
              ...
              return (AVX512c16f32{_mm512_div_ps(re_part,den),
	 ...
	 operator/(const AVX512c16f32 x,
	  ...
	  __ATTR_VECTORCALL__
          ...
          operator/(const AVX512c16f32 x,
                     const __m512 v) {
                return (AVX512c16f32{_mm512_div_ps(x.m_re,v),
	 ...
	 __ATTR_VECTORCALL__
         ...
         operator/(const __m512 v,
                   const AVX512c16f32 x) {
                return (AVX512c16f32{_mm512_div_ps(v,x.m_re),
	 ...
	 __ATTR_VECTORCALL__
        ...
        operator/(const AVX512c16f32 x,
               ...
               return (AVX512c16f32{_mm512_div_ps(x.m_re,zmm0),
	 ...
	 __ATTR_VECTORCALL__
        ...
        operator/(const float s,
                  const AVX512c16f32 x) {
               const __m512 zmm0 = _mm512_set1_ps(s);
               return (AVX512c16f32{_mm512_div_ps(zmm0,x.m_re),
	...
	__ATTR_VECTORCALL__
	 ...
	 __ATTR_VECTORCALL__
	  ...
	  __ATTR_VECTORCALL__
          static inline MMASK16_RETTYPE
          gms::math::operator<(const AVX512c16f32 x,
                      const AVX512c16f32 y) {
              const __mmask16 m1 =
