...
#ifndef __GMS_MELLINT_OMP_H__
#define __GMS_MELLINT_OMP_H__



namespace file_info{

const unsigned int GMS_MELLINT_OMP_MAJOR = 1;

const unsigned int GMS_MELLINT_OMP_MINOR = 0;

const unsigned int GMS_MELLINT_OMP_MICRO = 1;

const unsigned int GMS_MELLINT_OMP_FULLVER = 
	1000U*GMS_MELLINT_OMP_MAJOR + 100U*GMS_MELLINT_OMP_MINOR + 10U*GMS_MELLINT_OMP_MICRO;

const char * const GMS_MELLINT_OMP_CREATE_DATE = "02-02-2022 08:32 +00200 (WED 02 FEB 2022 GMT+2)";


const char * const GMS_MELLINT_OMP_BUILD_DATE =  __DATE__":"__TIME__;

const char * const GMS_MELLINT_OMP_AUTHOR  = "Programmer: Bernard Gingold contact: beniekg@gmail.com";

const char * const GMS_MELLINT_OMP_DESCRIPT = "Mellin Integral Transform computed by Quadpack Integrator: DQAGI.";
