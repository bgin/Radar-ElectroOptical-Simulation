...
/*
   icpc -o unit_test_AM_wb_signal_init -fp-model -std=c++17 fast=2 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_fast_pmc_access.h  GMS_dyn_array.h GMS_AM_wideband_signal.h GMS_AM_wideband_signal.cpp unit_test_AM_wb_signal_init_storage.cpp
   ASM: 
...
void unit_test_AM_wideband_signal_init_store();
...
int main()
{
    unit_test_AM_wideband_signal_init_store();
    return 0;
}