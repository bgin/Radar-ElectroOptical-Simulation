...
/*
   icpc -o unit_test_csinhv_svml_zmm16r4 -fp-model fast=2 -ftz -ggdb -ipo -qopt-zmm-usage=high -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5 -fopenmp \
   GMS_config.h GMS_malloc.h GMS_csinhv_svml_zmm16r4.h GMS_csinhv_svml_zmm16r4.cpp unit_test_csinhv_svml_zmm16r4.cpp
   ASM: 
   icpc -S -fverbose-asm -masm=intel -qopt-zmm-usage=high -march=skylake-avx512 -mavx512f -fopenmp -falign-functions=32 GMS_config.h GMS_malloc.h GMS_csinhv_svml_zmm16r4.h GMS_csinhv_svml_zmm16r4.cpp unit_test_csinhv_svml_zmm16r4.cpp
...
__attribute__((noinline))
__attribute__((aligned(32)))
void unit_test_csinhv_svml_zmm16r4_u10x_a();
...
void unit_test_csinhv_svml_zmm16r4_u10x_a()
{
    ...
    switch (which)
    {
        case 0 :
        {
            ...
            printf("[UNIT-TEST]: -- START: csinhv_svml_zmm16r4_u10x_a\n");
            ...
            printf("[UNIT-TEST]: csinhv_svml_zmm16r4_u10x_a -- TSC=%llu,TSC_AUX=%d\n",elapsed_tsc,tsc_aux);
            fp = fopen(fout,"w+");
            if(!fp)
            {
            ...
            if(xim_neq_0) gms_mm_free(xim);
            fclose(fp);
            printf("[UNIT-TEST]: -- END: csinhv_svml_zmm16r4_u10x_a\n");
        }
        break;
        case 1 :
        {
            ...
            printf("[UNIT-TEST]: -- START: csinhv_svml_zmm16r4_u10x_a\n");
            start  = __rdtscp(&tsc_aux);
            gms::math::csinhv_svml_zmm16r4_u10x_a(&xre[0],&xim[0],
                                                  &zre[0],&zim[0],nelems);
            end     = __rdtscp(&tsc_aux);
            start_c = start-RDTSCP_LAT;
            end_c   = end-RDTSCP_LAT;
...
__attribute__((noinline))
__attribute__((aligned(32)))
void unit_test_csinhv_svml_zmm16r4_u8x_a();
...
void unit_test_csinhv_svml_zmm16r4_u8x_a()
{
    ...
    switch (which)
    {
        case 0 :
        {
            ...
            printf("[UNIT-TEST]: -- End of data initialization\n");
            printf("[UNIT-TEST]: -- START: csinhv_svml_zmm16r4_u8x_a\n");
            start   = __rdtscp(&tsc_aux);
            gms::math::csinhv_svml_zmm16r4_u8x_a(&xre[0],&xim[0],
                                                  &zre[0],&zim[0],nelems);
            end     = __rdtscp(&tsc_aux);
            start_c = start-RDTSCP_LAT;
            end_c   = end-RDTSCP_LAT;
            elapsed_tsc = end_c-start_c;
            printf("[UNIT-TEST]: csinhv_svml_zmm16r4_u8x_a -- TSC=%llu,TSC_AUX=%d\n",elapsed_tsc,tsc_aux);
            fp = fopen(fout,"w+");
            if(!fp)
            {
                 std::perror("fopen failed to open a file -- TERMINATING!!");
            ...
            if(xim_neq_0) gms_mm_free(xim);
            fclose(fp);
            printf("[UNIT-TEST]: -- END: csinhv_svml_zmm16r4_u8x_a\n");
        }
        break;
        case 1 :
        {
...
__attribute__((noinline))
__attribute__((aligned(32)))
void unit_test_csinhv_svml_zmm16r4_u6x_a();
...
void unit_test_csinhv_svml_zmm16r4_u6x_a()
{
    ...
    switch (which)
    {
        case 0 :
        {
            ...
            printf("[UNIT-TEST]: -- End of data initialization\n");
            printf("[UNIT-TEST]: -- START: csinhv_svml_zmm16r4_u6x_a\n");
            start   = __rdtscp(&tsc_aux);
            gms::math::csinhv_svml_zmm16r4_u6x_a(&xre[0],&xim[0],
                                                  &zre[0],&zim[0],nelems);
            end     = __rdtscp(&tsc_aux);
            start_c = start-RDTSCP_LAT;
            end_c   = end-RDTSCP_LAT;
            elapsed_tsc = end_c-start_c;
            printf("[UNIT-TEST]: csinhv_svml_zmm16r4_u6x_a -- TSC=%llu,TSC_AUX=%d\n",elapsed_tsc,tsc_aux);
            fp = fopen(fout,"w+");
            if(!fp)
            {
                 std::perror("fopen failed to open a file -- TERMINATING!!");
            ...
            if(xim_neq_0) gms_mm_free(xim);
            fclose(fp);
            printf("[UNIT-TEST]: -- END: csinhv_svml_zmm16r4_u6x_a\n");
        }
        break;
        case 1 :
        {
...
{  
   warm_cache_L1I();
   unit_test_csinhv_svml_zmm16r4_u10x_a();
   unit_test_csinhv_svml_zmm16r4_u8x_a();
   unit_test_csinhv_svml_zmm16r4_u6x_a();
   return 0;
}