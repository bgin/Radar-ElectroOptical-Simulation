...
/*
   icpc -o unit_test_dyn_array_c8 -fp-model fast=2 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_dyn_array.h unit_test_dyn_array_c8.cpp
   ASM: 
   icpc -S -fverbose-asm -masm=intel  -march=skylake-avx512 -mavx512f -falign-functions=32   GMS_config.h GMS_malloc.h GMS_dyn_array.h unit_test_dyn_array_c8.cpp

*/


void unit_test_darray_c8_t_2nd_Ctor();
...
void unit_test_darray_c8_t_2nd_Ctor()
{
       ...
       int32_t status;
       const char * fname{"UNIT_TEST_Output_Random_Data_darray_c8_t_2nd_Ctor.csv"};
       std::clock_t seeds[2] = {0ULL};
       std::uniform_real_distribution<double> distros[2]{};
       FILE * fp{NULL};
       darray_c8_t test_2nd_Ctor = darray_c8_t(nx);
       ...
       {
           seeds[__i] = std::clock();
           distros[__i]  = std::uniform_real_distribution<double>(0.0f,1.0f);
       }
       auto rdev1{std::mt19937(seeds[0])};
       auto rdev2{std::mt19937(seeds[1])};
       for(std::size_t __i{0ULL}; __i != test_2nd_Ctor.mnx; ++__i)
       {
           const std::complex<double> rc{distros[0].operator()(rdev1),distros[1].operator()(rdev2)};
      ...
      fclose(fp);
      printf("[UNIT-TEST #1]: darray_c8_t_2nd_Ctor() -- Ended correctly!!\n");
}

void unit_test_darray_c8_t_3rd_Ctor();
...
void unit_test_darray_c8_t_3rd_Ctor()
{
       ...
       const char * fname{"UNIT_TEST_Output_Random_Data_darray_c8_t_3rd_Ctor.csv"};
       std::clock_t seeds[2] = {0ULL};
       std::uniform_real_distribution<double> distros[2]{};
       FILE * fp{NULL};
       int32_t status;
       darray_c8_t test_3rd_Ctor = darray_c8_t(nx,prot,flags,fd,offset,fsize);
       ...
       {
           test_3rd_Ctor.m_data[__i] = std::complex<double>{distros[0].operator()(rdev1),
       ...
       fclose(fp);
       printf("[UNIT-TEST #2]: darray_c8_t_3rd_Ctor() -- Ended correctly!!\n");
}


void unit_test_darray_c8_t_4th_Ctor();
...
void unit_test_darray_c8_t_4th_Ctor()
{
       ...
       int32_t status;
       const char * fname{"UNIT_TEST_Output_Random_Data_darray_c8_t_4th_Ctor.csv"};
       std::clock_t seeds[2] = {0ULL};
       std::uniform_real_distribution<double> distros[2]{};
       FILE * fp{NULL};
       std::vector<std::complex<double>> data = std::vector<std::complex<double>>(nx);
       printf("[UNIT-TEST]: -- Start of random data generation and initialization.\n");                                
       for(int32_t __i{0}; __i != 2; ++__i)
       {
           seeds[__i]   = std::clock();
       ...
       {
           data[__i] = std::complex<double>{distros[0].operator()(rdev1),
                                          distros[1].operator()(rdev2)};
       }
       printf("[UNIT-TEST]: End of random data generation and initialization.\n");
       darray_c8_t test_4th_Ctor = darray_c8_t(data);
       ...
       fclose(fp);
       printf("[UNIT-TEST #3]: darray_c8_t_4th_Ctor() -- Ended correctly!!\n");
}


void unit_test_darray_c8_t_5th_Ctor();
...
void unit_test_darray_c8_t_5th_Ctor()
{
       ...
       int32_t status;
       const char * fname{"UNIT_TEST_Output_Random_Data_darray_c8_t_5th_Ctor.csv"};
       std::clock_t seeds[2] = {0ULL};
       std::uniform_real_distribution<double> distros[2]{};
       FILE * fp{NULL};
       std::valarray<std::complex<double>> data = std::valarray<std::complex<double>>(nx);
       printf("[UNIT-TEST]: -- Start of random data generation and initialization.\n");                                
       for(int32_t __i{0}; __i != 2; ++__i)
       {
           seeds[__i]   = std::clock();
       ...
       printf("[UNIT-TEST]: End of random data generation and initialization.\n");
       darray_c8_t test_5th_Ctor = darray_c8_t(data);
       ...
       fclose(fp);
       printf("[UNIT-TEST #4]: darray_c8_t_5th_Ctor() -- Ended correctly!!\n");
}
...
int main()
{
   unit_test_darray_c8_t_2nd_Ctor();
   unit_test_darray_c8_t_3rd_Ctor();
   unit_test_darray_c8_t_4th_Ctor();
   unit_test_darray_c8_t_5th_Ctor();
   return 0;
}
