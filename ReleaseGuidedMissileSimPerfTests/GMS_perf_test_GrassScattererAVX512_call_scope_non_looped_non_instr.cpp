...
void perf_test_GrassScattererAVX512_call_scope_non_looped_non_instr() {
...
int  main(int argc, char *argv[]) {
  ...
  perf_test_GRassScattererAVX512_call_scope_non_looped_non_instr();
  return (0);
}
