...
/*
    icpc -o perf_test_sse_memcpyu16x_ps_2MiB -fp-model fast=2 -fno-exceptions -fopenmp -qopenmp -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5 \
    GMS_config.h  GMS_malloc.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_sse_memcpy.h GMS_sse_memcpy.cpp memmove-sse2-unaligned-erms.S perf_test_sse_memcpyu16x_ps_2MiB.cpp  
...
__attribute__((hot))
__attribute__((noinline))
void perf_test_sse_memcpy_unroll16x_ps_2MiB(float * __restrict__ ,
                                            float * __restrict__ ,
                                            unsigned __int64 * __restrict__ ,
                                            unsigned __int64 * __restrict__ ,
                                            unsigned __int64 * __restrict__ ,
...
void perf_test_sse_memcpy_unroll16x_ps_2MiB(float * __restrict__ dst,
...
#pragma omp parallel sections 
{
    ...
    #pragma omp section 
    {
        perf_test_sse_memcpy_unroll16x_ps_2MiB(dst_my_memcpy,
                                               src_my_memcpy,
                                               my_memcpy_s,
                                               my_memcpy_e,
                                               my_memcpy_d,
