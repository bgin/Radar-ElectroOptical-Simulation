...
#ifndef __GMS_CUSLSODA_ODE_CUH__
#define __GMS_CUSLSODA_ODE_CUH__
...
struct ODE_1 {
    ...
    __device__ void operator()(int32_t *  __restrict__ neq,
            ...
            ydot[0] = 1.0E4f*y[1]*y[2]-0.04E0f*y[0];
            ydot[2] = 3.0E7f*y[1]*y[1];
            ydot[1] = 1.0f*(ydot[0]+ydot[2]);
    }                 
};
...
struct ODE_2 {
   ...
   __device__ void operator()( int32_t *  __restrict__ neq,
          ...
          ydot[0] = -.04E0f*y[0] + 1.0E4f*y[1]*y[2];
          ydot[2] = 3.E7f*y[1]*y[1];
...
struct ODE_3 {
     ...
     __device__ void operator()(int32_t *  __restrict__ neq,
           ...
           ydot[0] = ydot[1];
           ydot[1] = 100.0E0f*(1.0E0f-y[0]*y[0])*y[1]-y[0];
...
struct JAC_3 {
      ...
      __device__ void operator()(int32_t * __restrict__ neq,
            ...
            pd[0] = 0.0E0f;
            pd[1] = 1.0E0f;
            pd[2] = -200.0E0f*y[0]*y[1]-1.0E0f;
            pd[3] = 100.0E0f*(1.0E0f-y[0]*y[1]);
      }
};
...
struct ODE_3 {
      ...
      __device__ void operator()(int32_t *  __restrict__ neq,
           ...
           ydot[0] = ((2.0E0f*__logf(y[0])+8.0E0f)/t-5.0E0f)*y[0];
      }
};
...
struct ODE_4 {
      ...
      __device__ void operator()(int32_t *  __restrict__ neq,
           ...
           ydot[0] = y[1];
           ydot[1] = 3.0E0f*(1.0E0f-y[0]*y[0])*y[1]-y[0];
     }
};
...
struct JAC_4 {
      ...
      __device__ void operator()(int32_t * __restrict__ neq,
           ...
           pd[0] = 0.0E0f;
           pd[1] = 1.0E0f;
           pd[2] = -6.0E0f*y[0]*y[1]-1.0E0;
           pd[3] = 3.0E0f*(1.0E0f-y[0]*y[0]);
     }
};
...
struct ODE_5 {
     ...
     __device__ void operator()( int32_t *  __restrict__ neq,
            ...
            prod1 = 7.89E0f-10.0E0f*y[0];
            prod2 = 1.1E7f*y[0]*y[2];
            prod3 = 1.13E9f*y[1]*y[2];
            prod4 = 1.13E3f*y[3];
            ydot[0] = -prod1 - prod2;
            ydot[1] = prod1 - prod3;
            ydot[3] = prod2 - prod4;
...
struct ODE_6 {
      ...
      __device__ void operator()(int32_t *  __restrict__ neq,
           ...
           const float A =  3.12121212f;
           const float B =  2.11111111f;
           ydot[0]        = A*y[2];
           ydot[1]        = B*y[3];
           ydot[2]        = -A*y[0];
           ydot[3]        = -B*y[1];  
...
struct ODE_7 {
      ...
      __device__ void operator()(int32_t *  __restrict__ neq,
             ...
             ydot[0] = 1.71E0f*y[0]+0.43E0f*y[1]+8.32E0f*y[2]+0.0007E0f;
             ydot[1] = 1.71E0f*y[0]-8.75E0f*y[1];
             ydot[2] = -10.03E0f*y[2]+0.43E0f*y[3]+0.035E0f*y[4];
             ydot[3] = 8.32E0f*y[1]+1.71E0f*y[2]-1.12E0f*y[3];
             ydot[4] = -1.745E0f*y[4] + 0.43E0f*(y[5]+y[6]);
             ydot[5] = -280E0f*y[5]*y[7]+0.69E0f*y[3]+1.71E0f*y[4]-0.43E0f*y[6]+0.69E0f*y[6];
             ydot[6] = 280.0E0f*y[5]*y[7]-1.81E0f*y[6];
             ydot[7] = -ydot[6];
      }
};
...
struct ODE_8 {
     ...
     __device__ void operator()(int32_t *  __restrict__ neq,
             ...
             ydot[0] = y[1];
             ydot[1] = 3.0E+0f*(1.0E+0f-y[0]*y[0])*y[1]-y[0];
      }
};
...
struct JAC_8 {
     ...
     __device__ void operator()(int32_t * __restrict__ neq,
            ...
            pd[0] = 0.0E+0f;
            pd[1] = 1.0E+0f;
            pd[2] = -6.0E+0f*y[0]*y[1]-1.0E+0f;
            pd[3] = 3.0E+0f*(1.0E+0f-y[0]*y[0]);
      }
};
...
struct ODE_9 {
     ...
     __device__ void operator()( int32_t *  __restrict__ neq,
           ...
           ydot[0] = -0.04E0f*y[0]+1.0E+4f*y[1]*y[2];
           ydot[1] = 0.04E0f*y[0]-1.0E+4f*y[1]*y[2]-3.0E+7f*(y[1]*y[1]);
           ydot[2] = 3.0E+7f*(y[1]*y[1]);
    }
};
...
struct ODE_10 {
       ...
       __device__ void operator()(int32_t *  __restrict__ neq,
             ...
             ydot[0] = 77.27E+0f*(y[1]+y[0]*(1.0E0f-8.375E-6f*y[0]-y[1]);
             ydot[1] = (y[2]-(1.0E+0f+y[0])*y[1])/77.27E+0f;
             ydot[2] = 0.161E+0f*(y[0]-y[2]);
       }
};
...
struct JAC_10 {
        ...
        __device__ void operator()(int32_t * __restrict__ neq,
             ...
             pd[0] = 77.27E0f*(1.0f-2.0f*8.375E-6f*y[0]-y[1]);
             pd[1] = 77.27E0f*(1.0f-y[0]);
             pd[2] = 0.0f;
             pd[3] = -y[1]/77.27f;
             pd[4] = -(1.0+y[0])/77.27f;
             pd[5] = 1.0/77.27f;
...
struct ODE_11 {
      ...
      __device__ void operator()(int32_t *  __restrict__ neq,
          ...
          float tmp             = y[0];
          ydot[0] = (1.0f/epsilon)*((1.0f-t)*tmp-tmp*tmp);
     }
};
...
struct JAC_11 {
      ...
      __device__ void operator()(int32_t * __restrict__ neq,
           ...
           const float epsilon = 1.0E-6f;
           pd[0] = (1.0f/epsilon)*(1.0f-t-2.0f*y[0]);
     }
};
#endif /*__GMS_CUSLSODA_ODE_CUH__*/
