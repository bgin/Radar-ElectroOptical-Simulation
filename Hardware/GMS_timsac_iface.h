...
#ifndef __GMS_TIMSAC_IFACE_H__
#define __GMS_TIMSAC_IFACE_H__
...
namespace file_info {
  ...
  const char * const pgGMS_TIMSAC_IFACE_BUILD_DATE  = "00-00-0000 00:00";
  const char * const pgGMS_TIMSAC_IFACE_AUTHOR      = " Programmer: Bernard Gingold, contact: beniekg@gmail.com";
	...
	*/
	 ...
	 */
	 ...
	 /*
              ...
              void MOD_TIMSAC_mp_AUTCORF(double * __restrict, <-- Ifort module subroutine encoding (left for reference)
				  int *, 
				  double * __restrict, 
				  double * __restrict, 
				  int *, 
