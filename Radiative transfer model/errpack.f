...
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      SUBROUTINE  ErrMsg( MESSAG, FATAL ) !GCC$ ATTRIBUTES section("Error_Handling")
#endif
...
c        Print out a warning or error message;  abort if error
   ...
   99 FORMAT( //,' >>>>>>  TOO MANY WARNING MESSAGES --  ',
     &   'They will no longer be printed  <<<<<<<', // )
      END
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
      LOGICAL FUNCTION  WrtBad ( VarNam ) !GCC$ ATTRIBUTES section("Error_Handling")
#endif
...
c                         ( CHARACTER, any length )
     ...
     &   CALL  ErrMsg ( 'Too many input errors.  Aborting...', .TRUE. )
      ...
      END
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
      LOGICAL FUNCTION  WrtDim ( DimNam, MinVal ) !GCC$ ATTRIBUTES section("Error_Handling")
#endif
...
c                        increased (at least)
     ...
     &                     '  should be increased to at least ', MinVal
      ...
      END
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
      LOGICAL FUNCTION  TstBad( VarNam, RelErr ) !GCC$ ATTRIBUTES section("Error_Handling")
#endif
