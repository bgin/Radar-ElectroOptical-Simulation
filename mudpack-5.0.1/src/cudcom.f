...
c
!$OMP PARALLEL DO SCHEDULE(STATIC,8) PRIVATE(i,j,k,ic,jc,kc,rm,rk,rp) &
...
c    (y,z) interior
c
C$OMP PARALLEL DO SCHEDULE(STATIC,8)  PRIVATE(j,k,jc,kc,rm,rk,rp) &
...
c     (x,z) interior
c
!$OMP PARALLEL DO SCHEDULE(STATIC,8)  PRIVATE(i,k,ic,kc,rm,rk,rp) &
...
c     (x,y) interior
c
!$OMP PARALLEL DO SCHEDULE(STATIC,8)  PRIVATE(i,j,ic,jc,rm,rk,rp) &
