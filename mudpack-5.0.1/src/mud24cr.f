...
c ... purpose
c
c     mud24cr attempts to improve the second order approximation generated
c     by mud2cr to a fourth order approximation using difference corrections
...
c
c
      subroutine mud24cr(work,coef,bndyc,phi,ierror)
      implicit none
      real work(*),phi(*)
      integer ierror
	...
	return
      ...
      call mu24cr(nx,ny,phi,coef,bndyc,work)
      end

      subroutine mu24cr(nx,ny,phi,coef,bndyc,wk)
      implicit none
...
c
      ...
      call tr2cr(nx,ny,phi,wk(icf),wk(irf),coef,bndyc)
c
...
c
	...
	do i=1,nx
      ...
      subroutine tr2cr(nx,ny,phi,cof,frhs,coef,bndyc)
c
...
c
      call tr2crd(nx,ny,phi,cof,frhs)
c
...
c     at (xa,yd)
      ...
      subroutine tr2crd(nx,ny,u,cof,frhs)
c
