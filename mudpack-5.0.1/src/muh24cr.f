...
c ... purpose
c
c     muh24cr attempts to improve the second order approximation generated
c     by muh2cr to a fourth order approximation using difference corrections
...
c
	...
	return
      ...
      call mh24cr(nx,ny,phi,coef,bndyc,wk,iwk)
      end
...
c
      ...
      call trh2cr(nx,ny,phi,wk(icf),wk(irf),coef,bndyc)
c
...
c
	...
	do i=1,nx
      ...
      subroutine trh2cr(nx,ny,phi,cof,frhs,coef,bndyc)
c
...
c
      call trh2crd(nx,ny,phi,cof,frhs)
c
...
c     at (xa,yd)
      ...
      subroutine trh2crd(nx,ny,u,cof,frhs)
c
