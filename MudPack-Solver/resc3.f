...
c
      subroutine resc3(nx,ny,nz,work,res)
       !dir$ attributes forceinline :: resc3
       !dir$ attributes code_align : 32 :: resc3
       !dir$ optimize : 3
c
...
c
      ...
      subroutine rec3(nx,ny,nz,phi,cof,res)
       !dir$ attributes forceinline :: rec3
       !dir$ attributes code_align : 32 :: rec3
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: rec3
      use omp_lib
      implicit none
      integer nx,ny,nz,i,j,k
      complex cof(nx,ny,nz,8),phi(0:nx+1,0:ny+1,0:nz+1),res(nx,ny,nz)
!$omp parallel do schedule(static,8) default(none) &
!$omp& private(k,j,i) shared(nz,ny,nx,res,cof,phi)
      do k=1,nz
	do j=1,ny
