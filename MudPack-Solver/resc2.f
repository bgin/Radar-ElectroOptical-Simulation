...
c
      subroutine resc2(nx,ny,work,res)
       !dir$ attributes forceinline :: resc2
       !dir$ attributes code_align : 32 :: resc2
       !dir$ optimize : 3
      implicit none
      integer nx,ny,ic
...
c
      ...
      subroutine rec2(nx,ny,phi,cof,res)
       !dir$ attributes forceinline :: rec2
       !dir$ attributes code_align : 32 :: rec2
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: rec2
      implicit none
      integer nx,ny,i,j
