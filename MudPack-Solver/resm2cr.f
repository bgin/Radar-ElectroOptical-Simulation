...
c
      subroutine resm2cr(nx,ny,work,res)
       !dir$ attributes forceinline :: resm2cr
       !dir$ attributes code_align : 32 :: resm2cr
       !dir$ optimize : 3
      implicit none
      integer nx,ny,ic
      real work(*),res(nx,ny)
...
c
      ...
      subroutine rem2cr(nx,ny,phi,cof,res)
       !dir$ attributes forceinline :: rem2cr
       !dir$ attributes code_align : 32 :: rem2cr
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: rem2cr
c
c     compute residual
c
      implicit none
