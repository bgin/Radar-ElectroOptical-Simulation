...
c
      subroutine resc2sp(nx,ny,nxa,nxb,nyc,nyd,work,res)
       !dir$ attributes forceinline :: resc2sp
       !dir$ attributes code_align : 32 :: resc2sp
       !dir$ optimize : 3
      implicit none
...
c
     ...
     +            work(icx),work(icy),res)
      ...
      subroutine rec2sp(nx,ny,nxa,nxb,nyc,nyd,phi,rhs,cofx,cofy,res)
       !dir$ attributes forceinline :: rec2sp
       !dir$ attributes code_align : 32 :: rec2sp
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: rec2sp
      use omp_lib
      implicit none
...
!$omp& shared(nx,ny,nxa,nxb,nxc,nyd,res,rhs,cofx,cofy,phi)
