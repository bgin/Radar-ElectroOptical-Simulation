...
c
      subroutine resc2cr(nx,ny,work,res)
       !dir$ attributes forceinline :: resc2cr
       !dir$ attributes code_align : 32 :: resc2cr
       !dir$ optimize : 3
      implicit none
      integer nx,ny,ic
      real work(*),res(nx,ny)
...
c
      ...
      subroutine rec2cr(nx,ny,phi,cof,res)
       !dir$ attributes forceinline :: rec2cr
       !dir$ attributes code_align : 32 :: rec2cr
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: rec2cr
c
c     compute residual
c
      implicit none
