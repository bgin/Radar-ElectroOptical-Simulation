...
c
      subroutine mud24(work,phi,ierror)
       ...
       !dir$ attributes code_align : 32 :: mud24
       !dir$ optimize : 3
      implicit none
      real phi(*),work(*)
	...
	return
      ...
      subroutine mu24(nx,ny,phi,wk)
       !dir$ attributes forceinline :: mu24
       !dir$ attributes code_align : 32 :: mu24
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: mu24
       use omp_lib
      implicit none
      integer nx,ny
      integer intl,nxa,nxb,nyc,nyd,ixp,jyq,iex,jey,nfx,nfy,iguess,
...
!$omp& private(j,jnx,i,ij) shared(ny,nx,phi,wk)
      do j=1,ny
	jnx = j*(nx+2)
...
!$omp end parallel do
      ...
      subroutine tr2(nx,ny,u,cof)
        !dir$ attributes code_align : 32 :: tr2
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: tr2
c
