...
c ... purpose
c
c     cuh24 attempts to improve the second order approximation generated
c     by cuh2 to a fourth order approximation using difference corrections
...
c     cuh2.f, cudcom.f
c
      subroutine cuh24(wk,iwk,phi,ierror)
       !dir$ attributes code_align : 32 :: cuh24
       !dir$ optimize : 3
      implicit none
      integer iwk(*)
      complex phi(*),wk(*)
	...
	return
      ...
      call ch24(nx,ny,phi,wk,iwk)
      end

      subroutine ch24(nx,ny,phi,wk,iwk)
       !dir$ attributes forceinline :: ch24
       !dir$ attributes code_align : 32 :: ch24
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: ch24
       use omp_lib
      implicit none
      integer nx,ny,iwk(*)
      integer intl,nxa,nxb,nyc,nyd,ixp,jyq,iex,jey,nfx,nfy,iguess,
...
!$omp parallel do default(none) private(j,jnx,i,ij) &
!$omp& shared(ny,nx,knx,phi,wk)
      do j=1,ny
	jnx = j*(nx+2)
...
!$omp end parallel do
      ...
      subroutine ctrh2(nx,ny,u,cof)
         !dir$ attributes forceinline :: ctrh2
       !dir$ attributes code_align : 32 :: ctrh2
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: ctrh2
       use omp_lib
c
