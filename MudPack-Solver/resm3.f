...
c
      subroutine resm3(nx,ny,nz,work,res)
       !dir$ attributes forceinline :: resm3
       !dir$ attributes code_align : 32 :: resm3
       !dir$ optimize : 3
c
...
c
      ...
      subroutine rem3(nx,ny,nz,phi,cof,res)
       !dir$ attributes forceinline :: rem3
       !dir$ attributes code_align : 32 :: rem3
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: rem3
       use omp_lib
      implicit none
