...
c
c
c ... assumptions (see cud3sp documentation)
c
...
c
      subroutine resc3sp(nx,ny,nz,nxa,nxb,nyc,nyd,nze,nzf,wk,res)
       !dir$ attributes forceinline :: resc3sp
       !dir$ attributes code_align : 32 :: resc3sp
       !dir$ optimize : 3
      implicit none
...
c
     ...
     +                  rhs,cofx,cofy,cofz,resf)
       !dir$ attributes forceinline :: res3sp
       !dir$ attributes code_align : 32 :: res3sp
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter: "TARGET_ARCH=skylake_avx512" :: res3sp
      use omp_lib
      implicit none
...
!$omp& shared(nz,ny,nx,nxa,nxb,nyc,nyd,nze,nzf,resf,rhs,cofx,phi,cofy,cofz)
