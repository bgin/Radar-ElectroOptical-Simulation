...
#include "GMS_rk3v2_step_avx512.h"
...
////////////////////////////////////////////////////////////////////////////////
			...
			__m512d
			gms::math::rk3v2_step_zmm8r8(__m512d(*f)(__m512d,
			                             __m512d),
					  __m512d y0,
					  __m512d x0,
					  const __m512d h,
			...
			__m512
			gms::math::rk3v2_step_zmm16r4(__m512(*f)(__m512,
			                             __m512),
					  __m512 y0,
					  __m512 x0,
					  const __m512 h,
...
#include <algorithm>
			...
			__m512d
			gms::math::rk3v2_richardson_zmm8r8(__m512d(*f)(__m512d,
			                                     __m512d),
						 __m512d y0,
						 __m512d x0,
						 const __m512d h,
			   ...
			   while(--n >= 0) {
				 ...
				 for(int32_t j = 0; j < n_cols; ++j) {
                                     integral = rk3v2_step_zmm8r8(f,y0,x0,h_used,n_subints);
			...
			__m512
			gms::math::rk3v2_richardson_zmm16r4(__m512(*f)(__m512,
			                                     __m512),
						 __m512 y0,
						 __m512 x0,
						 const __m512 h,
			   ...
			   while(--n >= 0) {
				 ...
				 #pragma loop_count min(1),max(6),avg(3)
				 for(int32_t j = 0; j < n_cols; ++j) {
                                     integral = rk3v2_step_zmm16r4(f,y0,x0,h_used,n_subints);
				     for(int32_t k = 0; k < j; ++k) {
