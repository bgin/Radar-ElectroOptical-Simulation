...
#include "GMS_rotations_avx512_helpers.hpp"
		      ...
		      DCM9x16
		      gms::math::q4x16_to_rmat9x16_zmm16r4(const __m512 q_x,
		                                const __m512 q_y,
						const __m512 q_z,
						const __m512 q_w) {
                            DCM9x16 rmat{};
			    ...
			    return (rmat);
                      ...
                      DCM9x8
		      gms::math::q4x8_to_rmat9x8_zmm8r8(const __m512d q_x,
		                             const __m512d q_y,
					     const __m512d q_z,
					     const __m512d q_w) {
		    ...
		    DCM9x16
		    gms::math::random_sphere_rm9x16_zmm16r4(const __m512 vr1,
		                                 const __m512 vr2,
                                                 const __m512 vr3) {
		    ...
		    DCM9x8
		    gms::math::random_sphere_rm9x8_zmm8r8(  const __m512d vr1,
		                                 const __m512d vr2,
                                                 const __m512d vr3) {
			  ...
			  return (rm);
	              ...
	              void
		      gms::math::urand_q4x16_a_zmm16r4(const __m512 vrx,   // random gaussian vector uniformly distributed [0,1]
		         ...
		         const  __m512 s1    = _mm512_fmadd_ps(vrx,vrx,_mm512_mul_ps(vry,vry));
			 const  __m512 num1  = _mm512_mul_ps(v16_n2,_mm512_log_ps(s1));
			 const  __m512 s2    = _mm512_fmadd_ps(vrz,vrz,_mm512_mul_ps(vrw,vrw));
			 const  __m512 num2  = _mm512_mul_ps(v16_n2,_mm512_log_ps(s2));
			 const  __m512 r     = _mm512_add_ps(num1,num2);
			 const  __m512 invr  = _mm512_div_ps(v16_1,r);
			 const  __m512 root1 = _mm512_sqrt_ps(_mm512_mul_ps(invr,_mm512_div_ps(num1,s1)));
			 _mm512_store_ps(&q_x[0], _mm512_mul_ps(vrx,root1));
			 _mm512_store_ps(&q_y[0], _mm512_mul_ps(vry,root1));
			 const  __m512 root2 = _mm512_sqrt_ps(_mm512_mul_ps(invr,_mm512_div_ps(num2,s2)));
			 ...
			 _mm512_store_ps(&q_w[0],  _mm512_mul_ps(vrw,root2));
	              ...
	              void
		      gms::math::urand_q4x16_u_zmm16r4(const __m512 vrx,   // random gaussian vector uniformly distributed [0,1]
		                            const __m512 vry,   // random gaussian vector uniformly distributed [0,1]
					    const __m512 vrz,   // random gaussian vector uniformly distributed [0,1]
					    const __m512 vrw,   // random gaussian vector uniformly distributed [0,1]
			 ...
			 _mm512_storeu_ps(&q_w[0],  _mm512_mul_ps(vrw,root2));
	              ...
	              void
		      gms::math::urand_q4x8_a_zmm8r8(  const __m512d vrx,   // random gaussian vector uniformly distributed [0,1]
		         ...
		         const  __m512d s1    = _mm512_fmadd_pd(vrx,vrx,_mm512_mul_pd(vry,vry));
			 const  __m512d num1  = _mm512_mul_pd(v8_n2,_mm512_log_pd(s1));
			 const  __m512d s2    = _mm512_fmadd_pd(vrz,vrz,_mm512_mul_pd(vrw,vrw));
			 const  __m512d num2  = _mm512_mul_pd(v8_n2,_mm512_log_pd(s2));
			 const  __m512d r     = _mm512_add_pd(num1,num2);
			 const  __m512d invr  = _mm512_div_pd(v8_1,r);
			 const  __m512d root1 = _mm512_sqrt_pd(_mm512_mul_ps(invr,_mm512_div_pd(num1,s1)));
			 _mm512_store_pd(&q_x[0], _mm512_mul_pd(vrx,root1));
			 _mm512_store_pd(&q_y[0], _mm512_mul_pd(vry,root1));
			 const  __m512d root2 = _mm512_sqrt_pd(_mm512_mul_pd(invr,_mm512_div_pd(num2,s2)));
			 ...
			 _mm512_store_pd(&q_w[0],  _mm512_mul_pd(vrw,root2));
	              ...
	              void
		      gms::math::urand_q4x8_u_zmm8r8(  const __m512d vrx,   // random gaussian vector uniformly distributed [0,1]
		                          const __m512d vry,   // random gaussian vector uniformly distributed [0,1]
					  const __m512d vrz,   // random gaussian vector uniformly distributed [0,1]
					  const __m512d vrw,   // random gaussian vector uniformly distributed [0,1]
		    ...
		    /*
	              ...
	              void
		      gms::math::q4x16_to_ea3x16_a_zmm16r4(const __m512 q_x,
		                              const __m512 q_y,
					      const __m512 q_z,
					      const __m512 q_w,
			 ...
			 _mm512_store_ps(&gamma[0], _mm512_mask_mov_ps(gamma_c,k3,fmod_zmm16r4(tmp2,v16_2pi)));
	              ...
	              void
		      gms::math::q4x16_to_ea3x16_u_zmm16r4(const __m512 q_x,
		                                const __m512 q_y,
					        const __m512 q_z,
					        const __m512 q_w,
			 ...
			 _mm512_storeu_ps(&gamma[0], _mm512_mask_mov_ps(gamma_c,k3,fmod_zmm16r4(tmp2,v16_2pi)));
	              ...
	              void
		      gms::math::q4x8_to_ea3x8_a_zmm8r8(   const __m512d q_x,
		                                const __m512d q_y,
					        const __m512d q_z,
					        const __m512d q_w,
			 ...
			 _mm512_store_pd(&gamma[0], _mm512_mask_mov_pd(gamma_c,k3,fmod_zmm8r8(tmp2,v8_2pi)));
	              ...
	              void
		      gms::math::q4x8_to_ea3x8_u_zmm8r8(   const __m512d q_x,
		                                const __m512d q_y,
					        const __m512d q_z,
					        const __m512d q_w,
		   ...
		   /*
		      ...
		      void
		      gms::math::q4x16_to_ax4x16_a_zmm16r4(const __m512 q_x,
		                                const __m512 q_y,
					        const __m512 q_z,
					        const __m512 q_w,
                          ...
                          const  __m512 t0 = _mm512_mul_ps(q_y,q_y);
			  const  __m512 t1 = _mm512_mul_ps(q_z,q_z);
			  const  __m512 t2 = _mm512_mul_ps(q_w,q_w);
			  const  __m512 v0 = _mm512_add_ps(t0,_mm512_add_ps(t1,t2));
			  __m512 c0 = v16_0;
			  __m512 c1 = v16_0;
			  __mmask16 k1 = 0x0;
			  __mmask16 k2 = 0x0;
			  ...
			  if(1==k2) {
			     ...
			     const  __m512 omega = _mm512_mul_ps(v16_2,
		      ...
		      void
		      gms::math::q4x16_to_ax4x16_u_zmm16r4(const __m512 q_x,
		                                const __m512 q_y,
					        const __m512 q_z,
					        const __m512 q_w,
		      ...
		      void
		      gms::math::q4x8_to_ax4x8_a_zmm8r8(   const __m512d q_x,
		                              const __m512d q_y,
					      const __m512d q_z,
					      const __m512d q_w,
                          ...
                          const  __m512d t0 = _mm512_mul_pd(q_y,q_y);
			  const  __m512d t1 = _mm512_mul_pd(q_z,q_z);
			  const  __m512d t2 = _mm512_mul_pd(q_w,q_w);
			  const  __m512d v0 = _mm512_add_pd(t0,_mm512_add_pd(t1,t2));
			  __mmask8 k1 = 0x0;
			  __mmask8 k2 = 0x0;
			  ...
			  if(1==k2) {
			     ...
			     const  __m512 omega = _mm512_mul_pd(v16_2,
		      ...
		      void
		      gms::math::q4x8_to_ax4x8_u_zmm8r8( const __m512d q_x,
		                              const __m512d q_y,
					      const __m512d q_z,
					      const __m512d q_w,
...
#include <limits>
		      ...
		      void
		      gms::math::q4x16_to_rv4x16_a_zmm16r4(const __m512 q_x,
		                              const __m512 q_y,
					      const __m512 q_z,
					      const __m512 q_w,
		      ...
		      void
		      gms::math::q4x16_to_rv4x16_u_zmm16r4(const __m512 q_x,
		                              const __m512 q_y,
					      const __m512 q_z,
					      const __m512 q_w,
		      ...
		      void
		      gms::math::q4x8_to_rv4x8_a_zmm8r8(   const __m512d q_x,
		                              const __m512d q_y,
					      const __m512d q_z,
					      const __m512d q_w,
		      ...
		      void
		      gms::math::q4x8_to_rv4x8_u_zmm8r8(   const __m512d q_x,
		                              const __m512d q_y,
					      const __m512d q_z,
					      const __m512d q_w,
		     ...
		     /*
		      ...
		      void
		      gms::math::rmat9x16_to_ea3x16_a_zmm16r4(const DCM9x16 rm,
		                                 float * __restrict __ATTR_ALIGN__(64) alpha,
						 float * __restrict __ATTR_ALIGN__(64) beta,
						 float * __restrict __ATTR_ALIGN__(64) gamma) {
		      ...
		      void
		      gms::math::rmat9x16_to_ea3x16_u_zmm16r4(const DCM9x16 rm,
		                                 float * __restrict  alpha,
						 float * __restrict  beta,
						 float * __restrict  gamma) {
		      ...
		      void
		      gms::math::rmat9x8_to_ea3x8_a_zmm8r8(const DCM9x8 rm,
		                              double * __restrict __ATTR_ALIGN__(64) alpha,
					      double * __restrict __ATTR_ALIGN__(64) beta,
					      double * __restrict __ATTR_ALIGN__(64) gamma) {
		      ...
		      void
		      gms::math::rmat9x8_to_ea3x8_u_zmm8r8(const DCM9x8 rm,
		                              double * __restrict  alpha,
					      double * __restrict  beta,
					      double * __restrict  gamma) {
