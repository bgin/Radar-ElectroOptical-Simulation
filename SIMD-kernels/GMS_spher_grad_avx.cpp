...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
		      ...
		      void  gms::math::spher_inv_jac_ymm4r8_a(double * __restrict __ATTR_ALIGN__(32) J0,
                         ...
                         switch (sysType)
						 {
							case 0 :
							{
			                    const __m256d nx = negate_ymm4r8(x);
                              //dx/dr
		    ...
		    void  gms::math::spher_inv_jac_ymm4r8_u(double * __restrict J0,
		    ...
		    void  gms::math::spher_inv_jac_ymm8r4_a(float * __restrict __ATTR_ALIGN__(32) J0,
						                            ...
						                            const int32_t sysType)
		   {
                    ...
                    switch (sysType)
					{
						case 0 :
						{
			               const __m256 nx = negate_ymm8r4(x);
                            //dx/dr
		    ...
		    void  gms::math::spher_inv_jac_ymm8r4_u(float * __restrict J0,
		                                            float * __restrict J1,
						                            float * __restrict J2,
						                            float * __restrict J3,
						                            float * __restrict J4,
		   ...
		   /*
		      ...
		      void  gms::math::spher_inv_jac_ymm4r8(__m256d * __restrict __ATTR_ALIGN__(32) J, //flatten 9x1 array
		                                 const __m256d x,
						 const __m256d y,
						 const __m256d z,
						 const int32_t sysType) {
			 ...
			 const __m256d cosel = _mm256_cos_pd(z);
		      ...
		      void  gms::math::spher_inv_jac_ymm8r4(__m256 * __restrict __ATTR_ALIGN__(32) J,
		                                  const __m256 x,
						  const __m256 y,
						  const __m256 z,
						  const int32_t sysType) {
...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
		...
		void gms::math::spher_ang_hess_ymm4r8(__m256d * __restrict __ATTR_ALIGN__(32) H,
		                                      const __m256d G0,
						                      const __m256d G1,
						                      const __m256d G2,
						                      const int32_t sysType) 
			...
			switch (sysType)
			{
				case 0 : 
				{
			            ...
			            const __m256d _0 = _mm256_setzero_pd();
			             ...
			             H[13]= _mm256_div_pd(negate_ymm4r8(_mm256_mul_pd(z,_mm256_add_pd(t3,t4))),t0);
			             H[17]= _mm256_div_pd(negate_ymm4r8(_mm256_mul_pd(_2,_mm256_mul_pd(rxy,z))),r4);
			             ...
			             H[15]= _mm256_div_pd(negate_ymm4r8(t3),c0);
			             H[11]= H[15];
			             t4   = _mm256_mul_pd(y,_mm256_sub_pd(_mm256_add_pd(x2,y2),z2));
			             H[16]= _mm256_div_pd(negate_ymm4r8(t4),c0);
			             H[14]= H[16];
			   }
			   break;
			   case 1 : 
			   {
			             ...
			             H[0] = _mm256_div_pd(negate_ymm4r8(_mm256_mul_pd(_2,_mm256_mul_pd(x,z))),r4xz);
			             H[4] = _0;
			             ...
			             H[13]= negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(_2,_mm256_mul_pd(y,rxz)),r4));
			             c3   = _mm256_mul_pd(x2,_mm256_mul_pd(_mm256_add_pd(y,z),_mm256_sub_pd(y,z)));
			             c4   = _mm256_fmsub_pd(x4,_2,_mm256_mul_pd(z2,z2));
			             H[17]= negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(y,_mm256_add_pd(c3,c4)),c0));
			             H[12]= negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(x,_mm256_add_pd(_mm256_sub_pd(x2,y2),z2)),c5));
			             H[10]= H[12];
			             ...
			             H[16]= negate_ymm4r8(_mm256_div_pd(c3,c5));
			             H[14]= H[16];
			  }
			  break;
			  case 2 : 
			  {
			             ...
			             H[7]  = _0;
			             H[5]  = H[7];
			             c1    = _mm256_fmsub_pd(negate_ymm4r8(_2),x4,_mm256_mul_pd(x2,y2));
			             ...
			             c2    = _mm256_mul_pd(x,_mm256_mul_pd(y,z));
			             H[12] = negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(c1,c2),c0));
			             H[10] = H[12];
			  ...
			  case 3 : 
			  {
			            ...
			            c0    = _mm256_mul_pd(rxy3,r4);
			            c5    = _mm256_mul_pd(rxy,r4);
			            H[0]  = negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(_2,_mm256_mul_pd(x,y)),r4xy));
			            H[4]  = H[0];
			            H[8]  = _0;
			            ...
			            H[13] = negate_ymm4r8(_mm256_div_pd(
							    _mm256_mul_pd(z,_mm256_add_pd(c3,c4)),c0));
			            H[17] = negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(_2,
			            ...
			            H[15] = negate_ymm4r8(_mm256_div_pd(c3,c5));
			            H[11] = H[15];
			            c4    = _mm256_mul_pd(y,_mm256_sub_pd(
			                                  _mm256_add_pd(x2,y2),z2));
			             H[16] = negate_ymm4r8(_mm256_div_pd(c4,c5));
			             H[14] = H[16];
			    }
			    break;
				default : 
		...
		void gms::math::spher_ang_hess_ymm8r4(__m256 * __restrict __ATTR_ALIGN__(32) H,
		                                            const __m256 G0,
						                            const __m256 G1,
						                            const __m256 G2,
						                            const int32_t sysType) 
			...
			switch (sysType)
			{
				case 0 :
				{
			          ...
			          const __m256 _0 = _mm256_setzero_ps();
			           ...
			           H[13]= _mm256_div_ps(negate_ymm8r4(_mm256_mul_ps(z,_mm256_add_ps(t3,t4))),t0);
			           H[17]= _mm256_div_ps(negate_ymm8r4(_mm256_mul_ps(_2,_mm256_mul_ps(rxy,z))),r4);
			           ...
			           H[15]= _mm256_div_ps(negate_ymm8r4(t3),c0);
			           H[11]= H[15];
			           t4   = _mm256_mul_ps(y,_mm256_sub_ps(_mm256_add_ps(x2,y2),z2));
			           H[16]= _mm256_div_ps(negate_ymm8r4(t4),c0);
			           H[14]= H[16];
			  }
			  break;
			  case 1 :
			  {
			           ...
			           H[0] = _mm256_div_ps(negate_ymm8r4(_mm256_mul_ps(_2,_mm256_mul_ps(x,z))),r4xz);
			           H[4] = _0;
			           ...
			           H[13]= negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(_2,_mm256_mul_ps(y,rxz)),r4));
			           c3   = _mm256_mul_ps(x2,_mm256_mul_ps(_mm256_add_ps(y,z),_mm256_sub_ps(y,z)));
			           c4   = _mm256_fmsub_ps(x4,_2,_mm256_mul_ps(z2,z2));
			           H[17]= negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(y,_mm256_add_ps(c3,c4)),c0));
			           H[12]= negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(x,_mm256_add_ps(_mm256_sub_ps(x2,y2),z2)),c5));
			           H[10]= H[12];
			           ...
			           H[16]= negate_ymm8r4(_mm256_div_ps(c3,c5));
			           H[14]= H[16];
			 }
			 break;
			 case 2 : 
			 {
			           ...
			           H[7]  = _0;
			           H[5]  = H[7];
			           c1    = _mm256_fmsub_ps(negate_ymm8r4(_2),x4,_mm256_mul_ps(x2,y2));
			           ...
			           c2    = _mm256_mul_ps(x,_mm256_mul_ps(y,z));
			           H[12] = negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(c1,c2),c0));
			           H[10] = H[12];
			 ...
			 case 3 :
			 {
			          ...
			          c0    = _mm256_mul_ps(rxy3,r4);
			          c5    = _mm256_mul_ps(rxy,r4);
			          H[0]  = negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(_2,_mm256_mul_ps(x,y)),r4xy));
			          H[4]  = H[0];
			          H[8]  = _0;
			          ...
			          H[13] = negate_ymm8r4(_mm256_div_ps(
							_mm256_mul_ps(z,_mm256_add_ps(c3,c4)),c0));
			          H[17] = negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(_2,
			          ...
			          H[15] = negate_ymm8r4(_mm256_div_ps(c3,c5));
			          H[11] = H[15];
			          c4    = _mm256_mul_ps(y,_mm256_sub_ps(
			                                  _mm256_add_ps(x2,y2),z2));
			          H[16] = negate_ymm8r4(_mm256_div_ps(c4,c5));
			          H[14] = H[16];
 		       }
			   break;
			   default : 
...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/		   
		      ...
		      void gms::math::spher_ang_grad_ymm4r8_a(double * __restrict __ATTR_ALIGN__(32) Mat0,
			  ...
			  if(sysType==0) {
			     ...
			     J0 = negate_ymm4r8(_mm256_div_pd(y,sqrv));
			     J1 = negate_ymm4r8(_mm256_div_pd(
			                                  _mm256_mul_pd(x,z),denom));
			      //Derivatives with respect to y.
			     J2 = _mm256_div_pd(x,sqrv);
			     J3 = negate_ymm4r8(_mm256_div_pd(
			     ...
			     J4 = _0;
			     J5 = negate_ymm4r8(_mm256_div_pd(sqrtv,r2));
			  }
			  else if(sysType==3) {
                             const __m256d r2   = _mm256_fmadd_pd(x,x,
			                               _mm256_fmadd_pd(y,y,
			     ...
			     J1 = negate_ymm4r8(_mm256_div_pd(
			                                  _mm256_mul_pd(x,z),denom));
			     J2 = negate_ymm4r8(_mm256_div_pd(x,sqrv));
			     J3 = negate_ymm4r8(_mm256_div_pd(
			                                  _mm256_mul_pd(y,z),denom));
			     J4 = _0;
			     J5 = _mm256_div_pd(sqrtv,r2);
			     ...
			     J4 = negate_ymm4r8(_mm256_div_pd(x,sqrv));
			     J5 = negate_ymm4r8(_mm256_div_pd(
		      ...
		      void gms::math::spher_ang_grad_ymm4r8_u(double * __restrict  Mat0,
		      ...
		      void gms::math::spher_ang_grad_ymm8r4_a(float * __restrict __ATTR_ALIGN__(32) Mat0,
			  ...
			  if(sysType==0) {
			     ...
			     const __m256 denom= _mm256_mul_ps(r2,sqrtv);
			      //Derivatives with respect to x.
			     J0 = negate_ymm8r4(_mm256_div_ps(y,sqrv));
			     J1 = negate_ymm8r4(_mm256_div_ps(
			                                  _mm256_mul_ps(x,z),denom));
			      //Derivatives with respect to y.
			     J2 = _mm256_div_ps(x,sqrv);
			     J3 = negate_ymm8r4(_mm256_div_ps(
			     ...
			     J4 = _0;
			     J5 = negate_ymm8r4(_mm256_div_ps(sqrtv,r2));
			  }
			  else if(sysType==3) {
                             const __m256 r2   = _mm256_fmadd_ps(x,x,
			                               _mm256_fmadd_ps(y,y,
			     ...
			     J1 = negate_ymm8r4(_mm256_div_ps(
			                                  _mm256_mul_ps(x,z),denom));
			     J2 = negate_ymm8r4(_mm256_div_ps(x,sqrv));
			     J3 = negate_ymm8r4(_mm256_div_ps(
			                                  _mm256_mul_ps(y,z),denom));
			     J4 = _0;
			     J5 = _mm256_div_ps(sqrtv,r2);
			     ...
			     J4 = negate_ymm8r4(_mm256_div_ps(x,sqrv));
			     J5 = negate_ymm8r4(_mm256_div_ps(
		      ...
		      void gms::math::spher_ang_grad_ymm8r4_u(float * __restrict  Mat0,
