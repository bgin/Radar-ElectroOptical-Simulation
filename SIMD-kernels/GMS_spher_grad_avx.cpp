...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
			 ...
			 if(sysType==0) {
			    ...
			    H[12]= negate_ymm4r8(_mm256_div_pd(_mm256_mul_pd(_mm256_add_pd(_mm256_sub_pd(x2,y2),z2)),c5));
			    H[10]= H[12];
			 ...
			 if(sysType==0) {
			    ...
			    H[12]= negate_ymm8r4(_mm256_div_ps(_mm256_mul_ps(_mm256_add_ps(_mm256_sub_ps(x2,y2),z2)),c5));
			    H[10]= H[12];
