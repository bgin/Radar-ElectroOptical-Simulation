...
#include <limits>
#include "GMS_derivative_avx512.h"
			...
			__m512d gms::math::stencil_5P_zmm8r8(__m512d (*f) (__m512d),
			                          __m512d vx,
						  __m512d vh,
						  __m512d &verr_ro,
						  __m512d &verr_tr) {
			...
			__m512d
			gms::math::stencil_5P_central_zmm8r8_optim(__m512d (*f) (__m512d),
			                        __m512d vx,
						__m512d vh,
						__m512d &vabserr) {
                            const __m512d vn0   = _mm512_setzero_pd();
			...
			__m512d gms::math::stencil_4P_zmm8r8(__m512d (*f)(__m512d),
			                          __m512d vx,
						  __m512d vh,
						  __m512d &verr_ro,
						  __m512d &verr_tr) {
			...
			__m512d
			gms::math::stencil_4P_forward_zmm8r8_optim(__m512d (*f) (__m512d),
			                                __m512d vx,
							__m512d vh,
							__m512d &vabserr) {
			...
			__m512d
			gms::math::stencil_4P_backward_zmm8r8_optim(__m512d (*f) (__m512d),
			                                 __m512d vx,
							 __m512d vh,
							 __m512d &vabserr) {
