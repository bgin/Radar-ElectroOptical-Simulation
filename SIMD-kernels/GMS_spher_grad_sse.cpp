...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
		      ...
		      void  gms::math::spher_inv_jac_xmm2r8_a(double * __restrict __ATTR_ALIGN__(16) J0,
			 ...
			 const __m128d cosel = _mm_cos_pd(z);
		      ...
		      void  gms::math::spher_inv_jac_xmm2r8_u(double * __restrict J0,
			 ...
			 const __m128d cosel = _mm_cos_pd(z);
		      ...
		      void  gms::math::spher_inv_jac_xmm4r4_a(float * __restrict __ATTR_ALIGN__(16) J0,
			 ...
			 const __m128 cosel = _mm_cos_ps(z);
		      ...
		      void  gms::math::spher_inv_jac_xmm4r4_u(float * __restrict J0,
		                                    float * __restrict J1,
						    float * __restrict J2,
						    float * __restrict J3,
						    float * __restrict J4,
		   ...
		   /*
			 ...
			 const __m128d cosel = _mm_cos_pd(z);
		      ...
		      void  gms::math::spher_inv_jac_xmm4r4(__m128 * __restrict __ATTR_ALIGN__(16) J,
		                                  const __m128 x,
						  const __m128 y,
						  const __m128 z,
						  const int32_t sysType) {
...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
		      ...
		      void gms::math::spher_ang_hess_xmm2r8(__m128d * __restrict __ATTR_ALIGN__(16) H,
		                                 const __m128d G0,
						 const __m128d G1,
						 const __m128d G2,
						 const int32_t sysType) {
