...
#ifndef __GMS_SLEEFSIMDDP_HPP__
#define __GMS_SLEEFSIMDDP_HPP__
...
/*EXPORT*/
  ...
  static
  inline
  vdouble atan2k(vdouble y, vdouble x) {
  vdouble s, t, u;
  vint q;
  vopmask p;
  ...
  static
  inline
  vdouble2 atan2k_u1(vdouble2 y, vdouble2 x) {
  vdouble u;
  vdouble2 s, t;
  vint q;
  vopmask p;
  ...
  static
  inline
  vdouble visinf2_vd_vd_vd(vdouble d, vdouble m) {
