...
#ifndef __GMS_SLEEFSIMDSP_HPP__
#define __GMS_SLEEFSIMDSP_HPP__
...
/*EXPORT*/ 
  ...
  inline
  vfloat 
  xldexpf(vfloat x, vint2 q) { return vldexp_vf_vf_vi2(x, q); }
...
/*EXPORT*/
  ...
  t = vadd_vf_vf_vf(vcast_vf_vi2(e), vcast_vf_f(6144));
  qu = vtruncate_vi2_vf(vmul_vf_vf_vf(t, vcast_vf_f(0.333333333333333333333333333333333f)));
  re = vtruncate_vi2_vf(vsub_vf_vf_vf(t, vmul_vf_vf_vf(vcast_vf_vi2(qu), vcast_vf_f(3))));
  ...
  y = vmul_vf_vf_vf(x, x); y = vmul_vf_vf_vf(y, y); x = vsub_vf_vf_vf(x, vmul_vf_vf_vf(vmlanp_vf_vf_vf_vf(d, y, x), vcast_vf_f(-0.333333333333333333333333333333333f)));
...
/*EXPORT*/
  ...
  y = vreinterpret_vf_vm(vor_vm_vo32_vm(vgt_vo_vf_vf(y, vcast_vf_f(1.0)), vreinterpret_vm_vf(vsel_vf_vo_vf_vf(veq_vo_vf_vf(y, vcast_vf_f(1.0)), vcast_vf_f(INFINITYf),
                                                                                                                vmul_vf_vf_vf(vadd_vf_vf_vf(d.x, d.y), vcast_vf_f(0.5))))));
