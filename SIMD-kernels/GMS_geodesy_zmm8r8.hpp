...
#if (USE_SLEEF_AVX512_LIB) == 1
                                    register __m512d zmm0  = xsin(vlat)
#else                                    			            
...
#if (USE_SLEEF_AVX512_LIB) == 1
                                    register __m512d zmm1  = xcos(vlat);
#else                                    			            
...
#if (USE_SLEEF_AVX512_LIB) == 1
                                    register __m512d zmm2  = xtan(vlat);
#else                                    			            
...
#pragma code_align(32)
			...
			label_10:
#if (USE_SLEEF_AVX512_LIB) == 1				
                                   register  vsy = xsin(vy);
				   register  vcy = xcos(vy);
				   register  vcz = xcos(_mm512_add_pd(vbaz,vy));
#else
...
#pragma code_align(32)
...
#if (USE_SLEEF_AVX512_LIB) == 1					  
				  register __m512d zmm0 = xcos(vlat1);
#else
                                  register __m512d zmm0 = _mm512_cos_pd(vlat1);
#endif				  
				  _mm_prefetch((const char*)&plon1[i+8],_MM_HINT_T0);
#if (USE_SLEEF_AVX512_LIB) == 1					  
				  register __m512d zmm1 = xsin(vlat1);
#else
...
#if (USE_SLEEF_AVX512_LIB) == 1					  
				  register __m512d zmm3 = xsin(vlat2);
#else
				  ...
				  register const __m512d vlon2 = _mm512_loadu_pd(&plon2[i]);
...
#if (USE_SLEEF_AVX512_LIB) == 1				          
			          register __m512d zmm2 = xcos(vlat2);
			      	  register __m512d zmm5 = xcos(zmm4);
#else
			          ...
			          register __m512d t0   = _mm512_mul_pd(zmm0,
			                                            _mm512_mul_pd(zmm2,zmm5));
#if (USE_SLEEF_AVX512_LIB) == 1				                                            
			          register __m512d zmm6 = xsin(zmm4);
#else
			          ...
			          t0   = _mm512_sqrt_pd(_mm512_add_pd(t2,t3));
#if (USE_SLEEF_AVX512_LIB) == 1				          
			          register __m512d vd    = _mm512_mul_pd(vr,xatan2(t0,t1));
#else
...
#endif /*__GMS_GEODESY_ZMM8R8_HPP__*/
