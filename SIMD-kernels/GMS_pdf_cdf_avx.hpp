...
*/
			 ...
			 //   }
                         __attribute__((section(".rodata")))
                         __ATTR_ALIGN__(32) static __m256 c[7] = { _mm256_set1_ps(-1.910444077728E-03),
                         ...
                         __attribute__((section(".rodata")))
			 __ATTR_ALIGN__(32) static __m256 p1[8] = {_mm256_set1_ps(4.945235359296727046734888E+00), 
                         ...
                         __attribute__((section(".rodata")))
			 __ATTR_ALIGN__(32) static __m256 p2[8] = {_mm256_set1_ps(4.974607845568932035012064E+00), 
                         ...
                         __attribute__((section(".rodata")))
			 __ATTR_ALIGN__(32) static __m256 p4[8] = {_mm256_set1_ps(1.474502166059939948905062E+04), 
                         ...
                         __attribute__((section(".rodata")))
                         __ATTR_ALIGN__(32) static __m256 q1[8] = {_mm256_set1_ps(6.748212550303777196073036E+01), 
                         ...
                         __attribute__((section(".rodata")))
			 __ATTR_ALIGN__(32) static __m256 q2[8] = {_mm256_set1_ps(1.830328399370592604055942E+02),
                         ...
                         __attribute__((section(".rodata")))
			 __ATTR_ALIGN__(32) static __m256 q4[8] = {_mm256_set1_ps(2.690530175870899333379843E+03), 
...
*/
		      ...
		      vpoly_eval_ymm4r8(const int32_t n,
		                        const __m256d * __restrict __ATTR_ALIGN__(32) a,
		                        const __m256d x) {
		      ...
		      vpoly_eval_ymm8r4(const int32_t n,
		                        const __m256 * __restrict __ATTR_ALIGN__(32) a,
		                        const __m256 x) {
		            ...
		            __ATTR_ALIGN__(32) static __m256d   c[8] = {
                          ...
                          if(_mm256_cmp_pd_mask(q,split1,_CMP_LE_OQ)) {
                             ...
                             if(_mm256_cmp_pd_mask(r,C0,_CMP_LE_OQ)) {
                                x = _mm256_set1_pd(std::numeric_limits<double>::max());
                             }
                             else {
		            ...
		            __ATTR_ALIGN__(32) static __m256   c[8] = {
                          ...
                          if(_mm256_cmp_ps_mask(q,split1,_CMP_LE_OQ)) {
                             ...
                             if(_mm256_cmp_ps_mask(r,C0,_CMP_LE_OQ)) {
                                x = _mm256_set1_pd(std::numeric_limits<float>::max());
                             }
                             else {
...
*/
		      ...
		      __m256 owen_tfunc_zmm16r4(const __m256 h,
		            ...
		            __ATTR_ALIGN__(32) static __m256  xtab[10] = {
		             ...
		             const __m256 tv1     = _mm256_set1_ps(std::numeric_limits<float>::min());
...
*/
		      ...
		      static inline           
                      ...
                      gamma_ymm4r8(const __m256d x) {
                         __attribute__((section(".rodata")))
                         __ATTR_ALIGN__(64) static __m256d  c[7] = {
                                        ...
                                        _mm256_set1_pd(5.7083835261e-03)};
                        __attribute__((section(".rodata")))
                        __ATTR_ALIGN__(64) static __m256d  p[8]  = {
                       ...
                       __attribute__((section(".rodata")))       
                       __ATTR_ALIGN__(64) static __m256d  q[8]   = {
		      ...
		      static inline           
                      ...
                      gamma_ymm8r4(const __m256 x) {
                         __attribute__((section(".rodata")))
                         __ATTR_ALIGN__(64) static __m256  c[7] = {
                        ...
                        __attribute__((section(".rodata")))
                        __ATTR_ALIGN__(64) static __m256  p[8]  = {
                       ...
                       __attribute__((section(".rodata")))         
                       __ATTR_ALIGN__(64) static __m256  q[8]   = {
