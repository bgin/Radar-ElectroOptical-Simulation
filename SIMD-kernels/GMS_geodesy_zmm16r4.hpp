...
#if (USE_SLEEF_AVX512_LIB) == 1
                                    register __m512 zmm0  = xsinf(vlat);
#else                                    			            
...
#if (USE_SLEEF_AVX512_LIB) == 1
                                    register __m512 zmm1  = xcosf(vlat);
#else                                    			            
...
#if (USE_SLEEF_AVX512_LIB) == 1	
                                    register __m512 zmm2  = xtanf(vlat);
#else                                    		            
...
#endif /*__GMS_GEODESY_ZMM16R4_HPP__*/
